...
// import { bgPlay } from '../../App/Sagas/PlaybackSagas'
// import PlaybackActions from '../../App/Redux/PlaybackRedux'
...
// test('first calls API', (t) => {
//   const step = stepper(bgPlay())
//   // first yield is API
//   t.deepEqual(step(), put(PlaybackActions.loadPlayingState()))
// })
